...
MainWindow::MainWindow(void)
{
	...
	setWindowIcon(QIcon(":/SpreadSheet/Resources/images/icon.png"));
	setCurrentFile("");
}
...
void MainWindow::createActions()
{
	...
	newAction->setIcon(QIcon(":/SpreadSheet/Resources/images/new.png"));
	newAction->setShortcut(QKeySequence::New);
	newAction->setStatusTip(tr("Create a new spreadsheet file"));
	connect(newAction, SIGNAL(triggered()), this, SLOT(newFile()));

	openAction = new QAction(tr("&Open..."), this);
	openAction->setIcon(QIcon(":/SpreadSheet/Resources/images/open.png"));
	openAction->setShortcut(QKeySequence::Open);
	openAction->setStatusTip(tr("Open an existing spreadsheet file"));
	connect(openAction, SIGNAL(triggered()), this, SLOT(open()));

	saveAction = new QAction(tr("&Save"), this);
	saveAction->setIcon(QIcon(":/SpreadSheet/Resources/images/save.png"));
	...
	cutAction->setIcon(QIcon(":/SpreadSheet/Resources/images/cut.png"));
	...
	copyAction->setIcon(QIcon(":/SpreadSheet/Resources/images/copy.png"));
	...
	pasteAction->setIcon(QIcon(":/SpreadSheet/Resources/images/paste.png"));
	...
	findAction->setIcon(QIcon(":/SpreadSheet/Resources/images/find.png"));
	findAction->setShortcut(QKeySequence::Find);
	findAction->setStatusTip(tr("Find a matching cell"));
	connect(findAction, SIGNAL(triggered()), this, SLOT(find()));

	goToCellAction = new QAction(tr("&Go to Cell..."), this);
	goToCellAction->setIcon(QIcon(":/SpreadSheet/Resources/images/gotocell.png"));
...
void MainWindow::writeSettings()
{
	...
	settings.setValue("geometry", saveGeometry());  // saveGeometry ?
...
void MainWindow::sort()
{
	...
	if (dialog.exec()) {
		...
		compare.keys[1] =
			dialog.secondarColumnCombo->currentIndex() - 1;
		compare.keys[2] =
